        ...
        >
          ...
          <Card className="overflow-visible">
            ...
            <CardContent>
              ...
              {/* Prezzo Standard + Suffisso (inline, NO card/border/ombra) */}
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6 mb-0">
                {/* Prezzo Standard */}
                <FormField
          ...
          <Card>
            ...
            <CardContent>
              {/* Raggruppa: Etichetta Prodotto + Prezzi multipli */}
