...
const ProductFeaturesCheckboxes: React.FC<Props> = ({
  ...
  return (
    <div className="px-0 mx-[20px] my-[20px]">
      <Label className="block text-base font-semibold mb-2">Caratteristiche</Label>
      {/* Layout responsivo: 1 colonna su mobile, 2 su desktop */}
