      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground mb-2">
              Questo titolo viene visualizzato nell'intestazione del pannello amministrativo
            </p>
            <div className="flex items-center gap-2">
              <Input id="admin-header-title" value={adminHeaderTitle} onChange={e => setAdminHeaderTitle(e.target.value)} placeholder="Titolo intestazione admin" className="max-w-md" />
