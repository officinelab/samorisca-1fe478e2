  ...
  return <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          {/* Titolo Header Amministrazione */}
          <div className="space-y-2">
            <Label htmlFor="admin-header-title">Titolo Intestazione Amministrativa</Label>
            <p className="text-sm text-muted-foreground mb-2">
              Questo titolo viene visualizzato nell'header del pannello amministrativo
            </p>
            <div className="flex items-center gap-2">
              <Input id="admin-header-title" value={adminHeaderTitle} onChange={e => setAdminHeaderTitle(e.target.value)} placeholder="Titolo intestazione" className="max-w-md" />
