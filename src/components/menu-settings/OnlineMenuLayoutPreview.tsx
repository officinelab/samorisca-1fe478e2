          ...
          <div className="max-w-2xl w-full min-w-[350px] border rounded-md shadow bg-white p-3 mx-auto">
            ...
            <ProductCardWrapper 
              ...
              fontSettings={{
                title: {
                  ...fontSettings.title,
                  fontSize: fontSettings.title?.desktop?.fontSize || fontSettings.title?.fontSize || 18
                },
                description: {
                  ...fontSettings.description,
                  fontSize: fontSettings.description?.desktop?.fontSize || fontSettings.description?.fontSize || 14
                },
                price: {
                  ...fontSettings.price,
                  fontSize: fontSettings.price?.desktop?.fontSize || fontSettings.price?.fontSize || 16
                }
              }} 
              buttonSettings={buttonSettings} 
            />
            <Label className="block text-center mt-2">{layoutLabel[selectedLayout]}</Label>
            <Button size="sm" variant="outline" className="mx-auto block mt-2" disabled>
