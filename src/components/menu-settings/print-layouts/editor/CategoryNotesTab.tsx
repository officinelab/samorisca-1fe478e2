    ...
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="grid grid-cols-4 gap-2">
            <div>
              <Label htmlFor="title-margin-top">Margine Sopra</Label>
              <Input
                id="title-margin-top"
                type="number"
                min="0"
            ...
            <div>
              <Label htmlFor="title-margin-right">Margine Destra</Label>
              <Input
            ...
            <div>
              <Label htmlFor="title-margin-bottom">Margine Sotto</Label>
              <Input
            ...
            <div>
              <Label htmlFor="title-margin-left">Margine Sinistra</Label>
              <Input
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="grid grid-cols-4 gap-2">
            <div>
              <Label htmlFor="text-margin-top">Margine Sopra</Label>
              <Input
                id="text-margin-top"
                type="number"
                min="0"
            ...
            <div>
              <Label htmlFor="text-margin-right">Margine Destra</Label>
              <Input
            ...
            <div>
              <Label htmlFor="text-margin-bottom">Margine Sotto</Label>
              <Input
            ...
            <div>
              <Label htmlFor="text-margin-left">Margine Sinistra</Label>
              <Input
                id="text-margin-left"
                type="number"
                min="0"
