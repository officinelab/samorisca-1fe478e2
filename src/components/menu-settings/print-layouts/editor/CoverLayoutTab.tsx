...
import LogoSettings from "./cover-components/LogoSettings";
import MenuText from "./cover-components/MenuText";
import StyleTabs from "./cover-components/StyleTabs";
...
const CoverLayoutTab: React.FC<CoverLayoutTabProps> = ({
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Sezione Testo Copertina */}
      <MenuText
        menuTitle={layout.menu_title || "Menu"}
        menuSubtitle={layout.menu_subtitle || "Ristorante"}
        onMenuTitleChange={onMenuTitleChange}
        onMenuSubtitleChange={onMenuSubtitleChange}
      />
