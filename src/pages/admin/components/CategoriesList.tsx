...
import { Edit, Trash2, PlusCircle, ChevronUp, ChevronDown, Package } from "lucide-react";
...
interface CategoriesListProps {
  ...
  onCategoryReorder: (categoryId: string, direction: "up" | "down") => void;
                    ...
                    <div className="flex justify-end mt-2">
                      <div className="flex mr-1">
                        <Button 
                          ...
                          size="sm"
                          className="h-6 w-6"
                          onClick={e => { e.stopPropagation(); onCategoryReorder(category.id, 'up'); }}
                          disabled={index === 0}
                        >
                        ...
                        <Button 
                          ...
                          size="sm"
                          className="h-6 w-6"
                          onClick={e => { e.stopPropagation(); onCategoryReorder(category.id, 'down'); }}
