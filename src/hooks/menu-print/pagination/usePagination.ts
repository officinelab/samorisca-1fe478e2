...
} from '../../../components/menu-print/pagination/utils/pageCalculations';
import { CategoryTitleContent, PageContent, PrintPageContent, ProductItem } from '../../../components/menu-print/pagination/types/paginationTypes';
    ...
    const generatePages = () => {
      ...
      filteredCategories.forEach((category, categoryIndex) => {
        ...
        categoryProducts.forEach((product, productIndex) => {
          // Stima dell'altezza del prodotto con un margine di sicurezza più ampio
          ...
          // Aggiungiamo un margine di sicurezza per evitare problemi
          if (currentHeight + productHeight > availableHeight * 0.95) {
